    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo site_url(); ?>/manager" class="logo">
          ...
          <span class="logo-lg"><b>ESKAMUGA CBT</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo base_url(); ?>hero-img.png" class="user-image" alt="User Image"/>
                  <span class="hidden-xs"><?php if(!empty($nama)){ echo $nama; }else{ echo 'Administrator'; } ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="<?php echo base_url(); ?>hero-img.png" class="img-circle" alt="User Image" />
                    <p>
      ...
      <footer class="main-footer">
        ...
        <strong>&copy; 2024 ibrahimelgibran.com</strong>
      </footer>
